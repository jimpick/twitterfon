...
#else
    "DELETE FROM timelines WHERE type = 0 and id >= (SELECT id FROM timelines WHERE type = 0 ORDER BY id DESC LIMIT 1 OFFSET 5)",
    "DELETE FROM timelines WHERE type = 1 and id >= (SELECT id FROM timelines WHERE type = 1 ORDER BY id DESC LIMIT 1 OFFSET 5)",
    "DELETE FROM timelines WHERE type = 2 and id >= (SELECT id FROM timelines WHERE type = 2 ORDER BY id DESC LIMIT 1 OFFSET 5)",
#endif
};
